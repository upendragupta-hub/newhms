...
const Navbar = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 border-b border-[var(--color-border)] bg-[var(--color-nav-bg)] shadow-[0_12px_32px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-colors duration-300">
            <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-6 py-4">
                ...
                <div className="flex flex-wrap items-center justify-end gap-3">
                    ...
                    {patient ? (
                        <>
                            ...
                            <button
                                ...
                                className="rounded-xl border border-[var(--color-border)] px-4 py-2 font-medium text-[var(--color-muted)] transition hover:border-rose-200 hover:bg-rose-50 hover:text-rose-600"
                            >
                                Logout
                            </button>
                        </>
                    ...
                    <button
                        type="button"
                        onClick={toggleTheme}
                        className="flex items-center gap-2 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-2 font-medium text-[var(--color-text)] transition hover:border-blue-300 hover:text-blue-600"
